<template>
    <div id="dashboard">
        <label><input id="file" type="file" accept=".json" />
        <el-button @click="download" type="primary" class="btn">下载数据</el-button>
        <el-button @click="upload" type="success" class="btn">导入数据</el-button></label>
